...
///
/// NOTE: this is a PARTIAL fix.  The remaining 28 shards are a distinct,
/// still-unidentified second cause — a subset of the original 184 that
/// correlates with neither the distance to the preceding non-Cpu shard nor
/// the memory-global address-boundary public values — so reth still does not
/// verify end to end.
///
